...
apptainer exec --nv $IMG bash -c "
    ...
    cd \"$HOME/AnomalyDetection\"
    python -m src.poc_expts.expt_batching_aachen --gpu_id 0 --jet_name both --merge_strategy concat --naming_identifier poc_baseline_aachen --guaranteed_signal_per_batch 0 --use_wandb
    "
