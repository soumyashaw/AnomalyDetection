...
def main():
    ...
    parser.add_argument("--injection_probability", type=float, default=1.0,
                       help="[DIAGNOSTIC] Probability of injecting signal jets into a batch (default: 1.0). If < 1.0, some batches will have the signal slots replaced with extra suppressed background jets.")
