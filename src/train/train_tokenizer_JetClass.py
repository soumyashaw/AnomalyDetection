""" VQ-VAE tokenizer training on JetClass dataset.

PROJECT STRUCTURE:
AnomalyDetection/
├── src/
│   ├── train/              # Training scripts (e.g., train_tokenizer_JetClass.py)
│   ├── eval/               # Evaluation scripts
│   ├── data/               # Data processing
│   ├── viz/                # Visualization
│   └── poc_expts/          # Proof-of-concept experiments
├── scripts/                # Job launchers
├── gabbro/                 # Core library (VQVAETransformer model)
...
USAGE: python -m src.train.train_tokenizer_JetClass [args]
Trains a VQ-VAE tokenizer on JetClass dataset for discrete representation learning.
"""
