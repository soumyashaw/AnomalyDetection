""" Python file to pre-train the OmniJet-alpha model with continuous tokens - Contrastive learning.
...
USAGE: python -m src.train.train [args]
Training the supervised anomaly detection model on LHCO datasets. (Trained on 200k bkg + 25k signal jets) (Tested on 200k bkg + 50k signal jets)
"""
# imports
import os
import json
...
def main():
    ...
    parser.add_argument("--dataset_path", type=str, default=str(os.getenv("DATASET_PATH")), help="Path to the LHCO dataset")
