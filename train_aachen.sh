...
apptainer exec --nv "$IMG" bash -lc '
    ...
    python train_custom_aachen.py --gpu_id 0 --seed 42 --jet_name both --merge_strategy concat --naming_identifier weak_5k_aachen --use_wandb 2>&1 | tee "$TRAIN_LOG"
    ...
    python evaluate.py --checkpoint "$BEST_CKPT" --model_type aachen
'
