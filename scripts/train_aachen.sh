...
apptainer exec --nv "$IMG" bash -lc '
    ...
    python -m src.train.train_custom_aachen --seed 42 --jet_name both --merge_strategy concat --naming_identifier weak_600_optimal_wopretrain_aachen --use_hpc --use_wandb
'
