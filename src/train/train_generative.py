""" Generative model training for OmniJet-alpha with continuous tokens.

PROJECT STRUCTURE:
AnomalyDetection/
├── src/
│   ├── train/              # Training scripts (e.g., train_generative.py)
...
USAGE: python -m src.train.train_generative [args]
Trains a generative model for unsupervised anomaly detection.
"""
# # imports
# import os
# import json
...
#         class_weights = [weight_background, weight_signal]  # CORRECT ORDER!
...
#     model_config = {
#         "architecture": "BackboneClassificationLightning",
