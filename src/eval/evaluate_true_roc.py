"""Evaluate trained anomaly detection model with ground-truth ROC curves and metrics.

PROJECT STRUCTURE:
AnomalyDetection/
├── src/
│   ├── train/              # Training scripts
│   ├── eval/               # Evaluation scripts (e.g., evaluate_true_roc.py)
...
├── Generate ROC curves with true labels
├── Calculate ROC AUC, AMS, and significance metrics
├── Multi-model comparison plots
└── Result caching for efficiency

USAGE: python -m src.eval.evaluate_true_roc --checkpoint_folder dijet_expts/run_ID/checkpoints/ --model_type dijet
"""
