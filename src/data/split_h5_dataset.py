#!/usr/bin/env python3
""" Script to split and resample an HDF5 dataset with configurable jet counts.
...
│   ├── data/               # Data processing (e.g., split_h5_dataset.py)
│   ├── viz/                # Visualization
│   └── poc_expts/          # Proof-of-concept experiments
├── scripts/                # Job launchers
└── [output directories: data/]

FEATURES:
├── Load HDF5 dataset
├── Resample with specified jet counts
├── Create multiple output files
├── Optional: stratified sampling
└── Reproducible with seed control

USAGE: python -m src.data.split_h5_dataset --input_file data/full.h5 --output_dir data/split/ [options]
Creates three copies of an HDF5 dataset, each with a configurable number of jets (defaults to 200k per file).
"""
