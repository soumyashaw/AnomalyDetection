""" VQ-VAE tokenizer training on LHCO dataset from HDF5 files.

PROJECT STRUCTURE:
AnomalyDetection/
├── src/
│   ├── train/              # Training scripts (e.g., train_tokenizer_LHCO.py)
│   ├── eval/               # Evaluation scripts
│   ├── data/               # Data processing
│   ├── viz/                # Visualization
│   └── poc_expts/          # Proof-of-concept experiments
├── scripts/                # Job launchers
├── gabbro/                 # Core library (VQVAETransformer model, HDF5 loaders)
...
USAGE: python -m src.train.train_tokenizer_LHCO [args]
Trains a VQ-VAE tokenizer on LHCO dataset from HDF5 files for discrete representation learning.
Data format: jet1/4mom (4-momentum), jet1/mask (padding mask), and signal labels.
"""
